...
dat = GenerateData(n = n, d = d, k0 = 1, r = 1, sigma = 0.001, flag = 0)

intpara = InitParam(d, k, lambda = 1)

sampling = factGibbsMod(X = dat$X, k = k, U0 = intpara$U, r0 = intpara$r,
                        sigma0 = 0.001, Ut = dat$U, No_Iter = 2000, burnin = 200, thin = 1)
...
sigma0 = 0.0001; Ut = dat$U; No_Iter = 30; burnin = 10; thin = 1
